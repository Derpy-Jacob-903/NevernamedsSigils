...
namespace NevernamedsSigils.Bloons
{
    public class Delayed : AbilityBehaviour
    {
        ...
        public static void Init()
        {
            ...
            AbilityInfo newSigil = SigilSetupUtility.MakeNewSigil("Delayed Attack", "[creature] will wait a set number of turns before being allowed to attack. After attacking, [creature] perishes.",
                      typeof(Delayed),
        ...
        public override IEnumerator OnAttackEnded()
        {
            ...
            if (base.Card != null && !base.Card.Dead)
            {
                ...
                yield return base.Card.Die(wasSacrifice: false);
